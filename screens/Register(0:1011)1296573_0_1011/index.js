    ...
    >
      ...
      <View style={styles.View_0_1024}>
        <View style={styles.View_0_1025}>
          <Text style={styles.Text_0_1025}>Register</Text>
        </View>
      </View>
      <View style={styles.View_0_1015}>
        <View style={styles.View_0_1016} />
        <View style={styles.View_0_1017}>
          <Text style={styles.Text_0_1017}>Email address</Text>
        </View>
      </View>
      <View style={styles.View_0_1018}>
        <View style={styles.View_0_1019} />
        <View style={styles.View_0_1020}>
          <Text style={styles.Text_0_1020}>Create password</Text>
        </View>
      </View>
      <View style={styles.View_0_1021}>
        <View style={styles.View_0_1022} />
        <View style={styles.View_0_1023}>
          <Text style={styles.Text_0_1023}>next</Text>
        </View>
      </View>
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/19942993-6440-4ca0-a7f6-9e50ae52f88c"
        }}
      ...
      <View style={styles.View_0_1026}>
        <View style={styles.View_0_1027}>
          <View style={styles.View_0_1028}>
            ...
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/6198ad09-7854-4b89-a542-d83523b5d262"
              }}
          ...
          <View style={styles.View_0_1032}>
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/d7e9228f-419c-45cd-aa03-c2829619404a"
              }}
          ...
          <View style={styles.View_0_1037}>
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/58474d2e-460b-43dd-8bb9-38396aa53b6f"
              }}
        ...
        <View style={styles.View_0_1043}>
          <View style={styles.View_0_1044}>
            <Text style={styles.Text_0_1044}>9:27</Text>
          </View>
        </View>
      </View>
    </ScrollView>
