"""
Django settings for kjjk_40982 project.
...
WSGI_APPLICATION = 'kjjk_40982.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kjjk_40982 API",
    "DESCRIPTION": "API documentation for kjjk_40982 App",
    "VERSION": "v1",
}
